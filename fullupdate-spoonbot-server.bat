...
echo Restarting snek...
plink -batch -pw Omega1314 -hostkey "f5:db:e8:20:b7:b2:dc:91:6a:c2:ab:b3:cc:40:0a:e0" spoon@192.168.1.50 "systemctl --user restart snek"
if errorlevel 1 ( echo RESTART FAILED & pause & exit /b 1 )

echo Waiting for startup...
plink -batch -pw Omega1314 -hostkey "f5:db:e8:20:b7:b2:dc:91:6a:c2:ab:b3:cc:40:0a:e0" spoon@192.168.1.50 "ping -c 6 127.0.0.1 > /dev/null && systemctl --user status snek | grep -E 'Active|Main PID'"
