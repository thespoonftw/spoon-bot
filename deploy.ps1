...
& $plink @conn "bash -c 'pkill -9 -f [t]s-node 2>/dev/null; tmux kill-server 2>/dev/null; sleep 1; fuser -k 3000/tcp 2>/dev/null; sleep 1; fuser -k 3000/tcp 2>/dev/null; sleep 1; exit 0'"
